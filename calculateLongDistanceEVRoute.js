// This file's logic has been moved to backend/routes/route.js
...
{
  for (const property in obj) this[property] = obj[property]
...
\
{
  ...
  \
  if (!hasOwnProperties(location, ["lat", "lng"])) return false;
...
\
{
  ...
  if (!hasProperty && defaultValue == null) return true;
...
\
{
  ...
  var url = \
  hasParameters: false, text
  : calculateLongDistanceEVRouteUrl \
