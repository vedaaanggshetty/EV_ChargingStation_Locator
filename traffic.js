// This file's logic has been moved to app/traffic/page.tsx
...
\
{
  return \
  type: "geojson", data
  : getPolygonSourceData(startCornerLngLat, endCornerLngLat)
    \
  \
}
...
\
{
  ...
  tt.services.incidentDetails(\{
            ...
            style: styleS1,
            zoomLevel: Number.parseInt(map.getZoom())
        \})
        .go()
