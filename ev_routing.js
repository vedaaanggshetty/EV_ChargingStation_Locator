// This file's logic has been moved to app/ev-routing/page.tsx
...
\
{
  ...
  if (lastTagName != null && lastTagName.charAt(0) != "H") element.appendChild(document.createElement("br"))
  \
}
...
\
{
  ...
  appendProperty(
    summary,
    properties,
    labels.remainingChargeAtArrivalInkWh,
  ...
  appendProperty(
    summary,
    properties,
    labels.totalChargingTimeInSeconds,
...
\
{
  ...
  if (startLocation != null) findLocation(ids.html.finish, calculateRoute)
  \
}
